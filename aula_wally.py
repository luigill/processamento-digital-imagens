...
for i in range(linha):
	for j in range(coluna):
		if image_RGB_color[i,j,0] < 150: #canal R
			if image_RGB_color[i,j,1] > 150 and image_RGB_color[i,j,1] < 255: #canal G 
				if image_RGB_color[i,j,2] > 0 and image_RGB_color[i,j,2] < 160: #canal B 
